...
<body class="min-h-screen bg-paper text-ink antialiased dark:bg-ink dark:text-paper">
    ...
    <footer class="mx-auto max-w-7xl px-5 py-10 text-sm text-ink/55 dark:text-paper/55 lg:px-8">
        <div class="flex items-center justify-between">
            <span>Nate OSINT · Public-source intelligence and cybersecurity inspection toolkit.</span>
            <a href="https://github.com/bhottu/Nate-OSINT" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 hover:text-ink dark:hover:text-paper transition-colors" aria-label="GitHub Repository">
